...
Purpose:
    ...
    Also stores CLIP embeddings for vector-based similarity matching.
    ...
    for i, artwork in enumerate(catalog):
        ...
        try:
            ...
            with torch.no_grad():
                ...
                artwork['attributes']['embedding'] = image_embedding.cpu().numpy().tolist()[0]
            ...
            print(f"  -> Embedding: {len(artwork['attributes']['embedding'])} dimensions")
