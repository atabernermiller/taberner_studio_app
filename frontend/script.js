...
function handlePurchaseClick(filename, title, price) {
    ...
    if (filename && title && price) {
        ...
        // Find the artwork data to get the product URL
...
// Update purchase button with current artwork's product URL and debug logging
    ...
    if (purchaseButton) {
        ...
        if (currentArtwork && currentArtwork.product_url) {
            ...
            purchaseButton.onclick = function() {
                ...
                console.log('[PurchaseButton] Clicked for artwork:', currentArtwork);
                console.log('[PurchaseButton] Opening product_url:', currentArtwork.product_url);
                console.log('Button element:', purchaseButton);
                window.open(currentArtwork.product_url, '_blank');
                console.log('Product URL opened in new tab');
            };
        } else {
